...
import com.matera.bootcamp.digitalbank.dto.request.ClienteResponseDTO;
...
public class ClienteService {
	...
	public List<ClienteResponseDTO> consultaTodos() {
		...
		clientes.forEach(cliente -> clienteResponseDTO.add(entidadeParaClienteResponseDTO(cliente)));
	...
	private Cliente validaAtualizacao(Long id, ClienteRequestDTO clienteRequestDTO) {
		...
		if (clienteRequestDTO.getCpf().equals(clienteExistente.getCpf()) && !clienteExistente.getId().equals(id)) {
